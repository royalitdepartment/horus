 ...
 * @since      2.0.0
 */
class SessionCookie extends \Horus\Middleware
{
    /**
     * @var array
     */
    ...
    protected function saveSession()
    {
        ...
        if (strlen($value) > 4096) {
            $this->app->getLog()->error('WARNING! Horus\Middleware\SessionCookie data size is larger than 4KB. Content save failed.');
        } else {
            $this->app->setCookie(
                $this->settings['name'],
                $value,
