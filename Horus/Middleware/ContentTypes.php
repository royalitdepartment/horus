...
namespace Horus\Middleware;
  ...
  * Content Types
  *
  * This is middleware for a Horus application that intercepts
  ...
  * @since      2.0.0
  */
class ContentTypes extends \Horus\Middleware
{
    /**
     * @var array
     */
    ...
    public function call()
    {
        ...
        if ($mediaType) {
            ...
            $env['Horus.input_original'] = $env['Horus.input'];
            $env['Horus.input'] = $this->parse($env['Horus.input'], $mediaType);
        }
        $this->next->call();
    }
