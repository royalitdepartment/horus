...
namespace Horus\Middleware;
  ...
  * Flash
  *
  * This is middleware for a Horus application that enables
  ...
  * @since      2.0.0
  */
class Flash extends \Horus\Middleware implements \ArrayAccess, \IteratorAggregate, \Countable
{
    /**
     * @var array
     */
    ...
    {
        $this->settings = array_merge(array('key' => 'Horus.flash'), $settings);
        $this->messages = array(
