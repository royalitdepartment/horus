...
namespace Horus\Middleware;
  ...
  *
  * This is middleware for a Horus application that allows traditional
  ...
  * @since      2.0.0
  */
class MethodOverride extends \Horus\Middleware
{
    /**
     * @var array
     */
     ...
     * Call
     *
     * Implements Horus middleware interface. This method is invoked and passed
     ...
     * modifies the environment settings so downstream middleware and/or the Horus
