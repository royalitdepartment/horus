 ...
 * Horus HTTP Request
 *
 * This class provides a human-friendly interface to the Horus environment variables;
...
class Request
{
    ...
    /**
     * Is this an XHR request? (alias of Horus_Http_Request::isAjax)
     * @return bool
     */
    ...
    public function cookies($key = null)
    {
        ...
        return $this->cookies;
        // if (!isset($this->env['Horus.request.cookie_hash'])) {
        //     $cookieHeader = isset($this->env['COOKIE']) ? $this->env['COOKIE'] : '';
        //     $this->env['Horus.request.cookie_hash'] = Util::parseCookieHeader($cookieHeader);
        // }
        // if ($key) {
        //     if (isset($this->env['Horus.request.cookie_hash'][$key])) {
        //         return $this->env['Horus.request.cookie_hash'][$key];
        //     } else {
        //         return null;
        //     }
        // } else {
        //     return $this->env['Horus.request.cookie_hash'];
        // }
    }
    ...
    {
        $method = isset($this->env['Horus.method_override.original_method']) ? $this->env['Horus.method_override.original_method'] : $this->getMethod();
    ...
    {
        return $this->env['Horus.url_scheme'];
    }
    ...
    /**
     * LEGACY: Get Root URI (alias for Horus_Http_Request::getScriptName)
     * @return string
     */
    ...
    /**
     * LEGACY: Get Resource URI (alias for Horus_Http_Request::getPathInfo)
     * @return string
     */
