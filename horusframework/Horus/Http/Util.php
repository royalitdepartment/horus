...
class Util
{
     ...
     * @param  \Horus\Http\Headers $headers The Response headers
     * @param  \Horus\Http\Cookies $cookies The Response cookies
     * @param  array              $config  The Horus app settings
     */
    public static function serializeCookies(\Horus\Http\Headers &$headers, \Horus\Http\Cookies $cookies, array $config)
    {
     ...
     *
     * This method will construct and set the HTTP `Set-Cookie` header. Horus
     ...
     *
     * This method accepts the Horus_Http_Headers object by reference as its
     ...
     * is already set in the HTTP response, it will also be removed. Horus uses this method
